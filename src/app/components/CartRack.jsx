...
const CartRack = ({ updateStock }) => {
  ...
  const HandleQuant = (item, value) => {
    return parallax.QuantHandle(item, value);
  };
  ...
  const HandleAdd = (SingleProduct) => {
    ...
    if (bool) {
      ...
      updateStock({ id: currentCart[i]._id, stock: newStock, type: "Inc" });
  ...
  return (
    <div className="min-h-screen mx-5 xxs:mx-10 lg:mx-28 text-white ">
      ...
      <div className="  gap-5 mb-5 grid grid-cols-1 lg:grid-cols-2">
        {produce.map((prod) => {
          return (
            <div className="  bg-[#121212] rounded-md xxs:px-5" key={prod._id}>
              <div className="xxs:my-5  flex justify-between items-center">
